...
import { GraduationCap, KeyRound, LogOutIcon, UserCog } from "lucide-react";
  ...
  return (
    <div className="w-full">
      ...
      <div
        ...
        onClick={() => setActive(3)}
      >
        <GraduationCap size={20} fill="#000" />
      ...
      <div
        className={`w-full flex items-center text-black font-medium px-3 py-4 cursor-pointer hover:bg-red-500 hover:rounded-xl ${
          active === 5 ? "bg-white rounded-md text-black" : "bg-transparent"
        }`}
        onClick={() => logoutHandler()}
      >
        <LogOutIcon size={20} fill="#000" />
        <h5 className="pl-2 text-black 800px:block hidden font-Poppins">
          Logout
        </h5>
      </div>
