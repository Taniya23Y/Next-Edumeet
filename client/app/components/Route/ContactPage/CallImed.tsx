...
const ContactInfo: React.FC<ContactInfoProps> = ({
  ...
  <div className="flex flex-col gap-[2px] p-3 text-sm text-richblack-200">
    <div className="flex flex-row items-center gap-3">
      {icon}
      <h1 className="text-lg font-semibold text-richblack-5">{title}</h1>
    </div>
  ...
  return (
    <div className="flex flex-col gap-6 rounded-xl p-4 lg:p-6">
      ...
      <ContactInfo
        ...
        details="123 Greenway Street, Sector 45, Indore, Madhya Pradesh, 452001, India"
      />
      <ContactInfo
        icon={
          <svg
        ...
        details="+91 6366 xxx xxx"
      />
    </div>
  );
};

export default CallImed;
